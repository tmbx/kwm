...
namespace kwm.Utils
{
    public class SplitButton : Button 
    {
        ...
        protected override void OnMouseDown(MouseEventArgs e) {
            ...
            if (dropDownRectangle.Contains(e.Location) || e.Button == MouseButtons.Right) {
                ShowContextMenuStrip();
            }
            else {
                State = PushButtonState.Pressed;
        ...
        private void ShowContextMenuStrip() {
            ...
            if (dropDown != null)
            {
                dropDown.Closing += new ToolStripDropDownClosingEventHandler(ContextMenuStrip_Closing);
                dropDown.Show(this, new Point(0, Height), ToolStripDropDownDirection.BelowRight);
            }
        }

        void ContextMenuStrip_Closing(object sender, ToolStripDropDownClosingEventArgs e) {
        //void ContextMenuStrip_Closing(object sender, EventArgs e) {
            ContextMenuStrip cms = sender as ContextMenuStrip;
            //ContextMenu cms = sender as ContextMenu;
            if (cms != null) {
                cms.Closing -= new ToolStripDropDownClosingEventHandler(ContextMenuStrip_Closing);
                //cms.Collapse -= new EventHandler(ContextMenuStrip_Closing);
            }
